                        ...
                        <div class="panel-body">
                          <form method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="companyEmail" placeholder="Your email" value="<?php echo $row['userEmail'];  if(isset($_GET['edit'])) echo $Row['companyEmail']?>" class="form-control"/>
                                                        </div>
                                                          ...
                                                          <div class="form-group">
                                                           ...
                                                           <select name="level" class="form-control">
                                                            ...
                                                            <option value="Attachment">Attachment/Internship</option>
