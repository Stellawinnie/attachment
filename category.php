                      ...
                      <div class="panel-heading">
                        ...
                        <div class="panel-body">
                          <div class="list-group">
                              ...
                              <?php
                              $name = $row['userName'];
                              $res = $conn->query("SELECT * FROM tbl_posts WHERE category='$cat'");
                              ...
                              <span class="list-group-item">
                                  ...
                                  <span class="text-muted pull-right"><?php echo $Row['postTime']; ?></span>
                                   <hr>
                                  <a href="mailto:<?php echo $Row['companyEmail']; ?>"> <i class="fa fa-envelope-o fa-fw"><?php echo $Row['companyName']; ?></i></a><br>
                                  <span class="fa fa-phone fa-fw"> 0<?php echo $Row['companyPhone']; ?></span><br>
                                  <?php
                                  $postId = $Row['id'];
                                  $resp = $conn->query("SELECT * FROM tbl_applicants WHERE userName='$name' AND postId='$postId'");
                                  $Roow=$resp->fetch_array();
                                  if ($Roow['sent']=='No'){?>
                                    ...
                                    <a href="?apply=<?php echo $Row['id']; ?>"><i class="fa fa-pencil fa-fw">Apply</i></a>
                                    <?php
                                  } else if($Roow['sent']=='Yes'){
                                    ?>
